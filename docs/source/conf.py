...
# a107 configuration, copied from below
#
# **original** f311 documentation build configuration file, created by
...
# html_theme = 'haiku'
# html_theme = 'graphite'
# html_theme_path = ["/home/j/Documents/a107/docs"]
...
latex_documents = [
    (master_doc, 'a107.tex', 'a107 Documentation',
     'JT', 'manual'),
]
...
man_pages = [
    (master_doc, 'a107', 'a107 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'a107', 'a107 Documentation',
     author, 'a107', 'Multi-purpose API for Python',
     'Miscellaneous'),
]
